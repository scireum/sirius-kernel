...
public class Exceptions {
    ...
    public static class ErrorHandler {
         ...
         * <p>
         * Note: When used, an additional '- %s (%s)' could be added at the end of the error message provided when concatenating a {@link ErrorHandler#withSystemErrorMessage(String, Object...)} call.
         *
         ...
         * <p>
         * Note: When combining with {@link ErrorHandler#error(Throwable)} an optional '- %s (%s)' could be added at the end of the provided message to output the errorMessage and errorClass.
         *
