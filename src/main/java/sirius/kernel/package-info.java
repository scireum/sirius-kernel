 ...
 * <li>instance.conf - This file is not loaded from the classpath but form the local file system (where the app is
 * started)</li>
 * </ol>
 * <p>
 ...
 * disabled by setting {@code sirius.frameworks.kernel.timer = false}. By default this the timer is
 ...
 * <b>frameworks</b> the config property {@code sirius.customizations} - which is a list, so that several
